...
const ModalS = () => {
	...
	const selected = useRecoilValue(animalSelectedItem);
	const [isOpen, setIsOpen] = useRecoilState(animalModalIsOpen);
	...
	async function put(data) {
		const urlPost = `http://localhost:4000/api/v1/animals/${selected.id}`;
